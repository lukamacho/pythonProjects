# This is a sample Python project for advanced snake where you can simply add extensions.
...
class cube(object):
    ...
    def draw(self, surface, eyes=False):
        ...
        if eyes:
            centre = dis // 2
            radius = 3
            circleMid = (i*dis +centre, j*dis + 8)
    ...
    def move(self):
        ...
        for i, c in enumerate(self.body):
            ...
            if p in self.turns:
                ...
                else: c.move(dirnx=c.dirnx, dirny=c.dirny)
    ...
    while flag:
        ...
        for x in range(len(s.body)):
            if s.body[x].pos in list(map(lambda x: x.pos,s.body[x+1:])):
                ...
                message_box("You lost!"," Don't worry try again...")
                s.reset((10, 10))
                break
